          ...
          {reports.map(report => (
            <tr key={report.id} className='text-center'>
              ...
              <td className="border px-4 py-2">
                <button className="bg-transparent text-black px-2 py-1 mr-2 hover:bg-gray-100 hover:rounded-sm-lg hover:text-gray-800" onClick={() => handleEditReport(report.id)}>
                  Edit
                </button>
                <button className="bg-transparent text-red-500 px-2 py-1 hover:bg-red-500 hover:rounded-sm-lg hover:text-white" onClick={() => handleDeleteReport(report.id)}>
                  Delete
                </button>
              </td>
            </tr>
            ...
            <form className="p-4 md:p-5" onSubmit={(e) => {
              ...
              <div className="grid gap-4 mb-4 grid-cols-2">
                <div className="col-span-2">
                  ...
                  <input type="text" name="typeOfIncident" id="typeOfIncident" value={newReport.typeOfIncident} onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type of Incident" required={true} />
                </div>
                <div className="col-span-2">
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <input type="date" name="dateIncident" id="dateIncident" value={newReport.dateIncident} onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required={true} />
                </div>
                <div className="col-span-2 sm:col-span-1">
                  <label htmlFor="secOfficer" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Security Officer</label>
                  <input type="text" name="secOfficer" id="secOfficer" value={newReport.secOfficer} onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Security Officer" required={true} />
                </div>
                <div className="col-span-2">
                  <label htmlFor="comments" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Comments</label>
                  <input type="text" name="comments" id="comments" value={newReport.comments} onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Comments" required={true} />
                </div>
              </div>
